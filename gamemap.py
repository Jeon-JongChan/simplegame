...
class Gamemap:
    def __init__(self,table,level = 0):
        ...
        self.map_x_pos = []
        self.map_y_pos = []
        #self.map_x_pos.append([[350,350],[450,450]]) #level 0
        ...
        #self.map_x_pos.append([[0,800],[0,750],  [800,800],[750,750],[3,800],  [50,750], [3,3],    [50,50],  [3,700],  [50,650], [700,700],[650,650],[110,700],[180,650],[110,110],[180,180],[110,600],[180,600]])   #level 4
        #self.map_y_pos.append([[20,20],[120,120],[20,700], [120,600],[700,700],[600,600],[170,700],[270,600],[170,170],[270,270],[170,550],[270,450],[550,550],[450,450],[320,550],[390,450],[320,320],[390,390]])   #level 4
        self.table = table
